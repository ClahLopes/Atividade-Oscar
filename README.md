...
<b>QUERY EM SQL</b><br>
<code>SELECT name, film, category FROM oscar WHERE category LIKE '%CINEMATOGRAPHY' OR category LIKE '%ACTRESS' OR category LIKE '%DIRECTING' AND winner LIKE '%1%' AND year_ceremony = '2004' GROUP BY category;</code>
...
<b>
R: <code>INSERT INTO oscar (name) VALUES ('Cameron Diaz'), ('Nina Drobev'), ('Sarah Polley'), ('Emily Blunt'), ('Robin Wright'), ('Charlotte Gainsbourg'), ('Kirsten Dunst');</code>
